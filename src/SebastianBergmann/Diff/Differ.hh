...
class Differ {
     ...
     * @return string
     */
    public function diff(mixed $from, mixed $to, ?LongestCommonSubsequence $lcs = null) {
     ...
     * @return array
     */
    public function diffToArray(array $from, array $to, ?LongestCommonSubsequence $lcs = null) {
     ...
     */
    private function selectLcsImplementation(array $from, array $to): LongestCommonSubsequence
    {
