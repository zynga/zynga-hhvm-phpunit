...
class Requirements extends TestCase
{
    ...
    <<requires("function testFuncThatDoesNotExist")>>
    ...
    <<requires(["PHP 99-dev", "PHPUnit 9-dev", "OS DOESNOTEXIST", "function testFuncOne", "function testFuncTwo", "extension testExtOne", "extension testExtTwo", "extension testExtThree 2.0"])>>
